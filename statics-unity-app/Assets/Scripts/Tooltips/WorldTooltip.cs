...
public class WorldTooltip : MonoBehaviour {
    ...
    private static WorldTooltip instance;
    ...
    private void Update() {
        ...
        RectTransformUtility.ScreenPointToLocalPointInRectangle(transform.parent.GetComponent<RectTransform>(), Input.mousePosition, worldCamera, out localPoint);
        ...
        anchoredPos = anchoredPos + new Vector3(0,0,0f); // To be on top of other object in scene
